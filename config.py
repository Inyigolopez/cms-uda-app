...
class Config(object):
    ...
    BLOB_STORAGE_KEY = os.environ.get('BLOB_STORAGE_KEY') or 'MED1WY0LwjVEN/+eTozqY7UuWXMRT/EYCL9Cy0zfD2FJ90aW+tJO5zyapWOyYOJFBtF9lTicb+QWnxxwoVzheQ=='
    ...
    CLIENT_SECRET = "CGuX60Rrtmu~6Qy~Y~Mv3rccPrHW8~01II"
    ...
    CLIENT_ID = "c72c19d5-8ccf-424a-aaa4-b8844ab15174"
